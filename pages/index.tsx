...
export default function Home({ currentYear }: { currentYear: number }) {
  return (
    <Layout title="Nitesh Bisht | Software Engineer Portfolio" description="Portfolio of Nitesh Bisht, a Software Engineer specializing in modern web applications with React, Node.js, and more.">
      ...
      >
        {/* Hero Section */}
        <motion.header variants={fadeInUp} className="text-center space-y-6 py-12">
          <h1 className="text-5xl sm:text-6xl font-extrabold text-blue-600 tracking-tight">Nitesh Bisht</h1>
          <p className="text-lg sm:text-xl text-gray-700 font-medium">Software Engineer & Web Developer</p>
          <p className="text-sm text-gray-500">📍 Haldwani, Uttarakhand</p>
          <div className="flex justify-center gap-4 text-sm text-gray-600">
            <p>📞 <a href="tel:+916396902252" className="text-blue-500 hover:underline">6396902252</a></p>
            <p>📧 <a href="mailto:bnitesh400@gmail.com" className="text-blue-500 hover:underline">bnitesh400@gmail.com</a></p>
          </div>
        ...
        <motion.section variants={fadeInUp}>
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">Professional Experience</h2>
        ...
        <motion.section variants={fadeInUp} className="bg-white shadow-lg rounded-xl p-8">
          ...
          <p className="text-gray-600">Graphic Era Hill University, Dehradun (2015 - 2019)</p>
        </motion.section>
        ...
        {/* Skills */}
        <motion.section variants={fadeInUp}>
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">Technical Skills</h2>
        ...
        {/* Call to Action */}
        <motion.section variants={fadeInUp} className="text-center py-12 bg-blue-50 rounded-xl">
